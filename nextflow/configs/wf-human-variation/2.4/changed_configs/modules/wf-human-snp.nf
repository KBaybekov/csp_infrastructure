// CSP: This file goes to /path/to/.nextflow/assets/epi2me-labs/wf-human-variation/modules/local/

import groovy.json.JsonBuilder

def longphase_memory = [64.GB, 128.GB, 256.GB]
def whatshap_memory = [32.GB, 64.GB, 96.GB]
def haptag_memory = [32.GB, 64.GB, 96.GB]
def aggregate_memory = [32.GB, 64.GB, 96.GB]
...
process phase_contig {
    ...
    script:
        ...
        bgzip -@ ${task.cpus} phased_${contig}.vcf
...
process merge_pileup_and_full_vars{
    ...
    shell:
        ...
        bgzip -c -@ !{task.cpus} output/merge_!{contig}.vcf > output/merge_!{contig}.vcf.gz
...
process post_clair_contig_haplotag {
    ...
    whatshap haplotag \
        ...
        ${xam} \
    | samtools view -@ ${task.cpus} -O bam --reference $ref -@3 -o ${contig}_hp.bam##idx##${contig}_hp.bam.bai --write-index
    """
}
